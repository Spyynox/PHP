...
var_dump($_POST);
	...
	if (isset($_POST["submit"])) {
		...
		if (filter_var($_POST["mail1"], FILTER_VALIDATE_EMAIL) == false) {
			array_push($erreur, "Tu n'as pas selectioné le mail")
		}
		...
		if ( ($_POST["Bachelor"] == "dev" || $_POST["Bachelor"] == "design" || $_POST["market"])) {
			# code...
		}
